...
<div class="wrapper">
	   	...
	   	<!-- Form -->
<form class="form" id="form" action="<?php echo admin_url('news/update') ?>"a method="post" enctype= 					 																							"multipart/form-data">
	<fieldset>
    ...
    <div class="tab_container">
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <span class="oneTwo"><input name="title" id="param_title" value="<?php echo $row->title ?>" _autocheck="true" type="text"></span>
                <span name="name_autocheck" class="autocheck"></span>
                <div name="name_error" class="clear error"></div>
            </div>
            <div class="clear"></div>
        ...
        <div class="formRow">
            <label class="formLeft">Hình ảnh:<span class="req">*</span></label>
                ...
                <div class="">
                        <img  style=" margin-left: 60%; height:100px ; width: 200px; "
                            src='<?php echo base_url("uploads/news/".$row->image_link )?>' height="50">
                        <div class="clear"></div>
                </div>
        ...
        <!-- Price -->
        <div class="formRow">
            <label class="formLeft" for="param_price">Lời dẫn :<span class="req">*</span></label>
            <div class="formRight">
                <span class="oneTwo">
                  <textarea name="intro" id="param_intro" ><?php echo $row->intro ?></textarea>
                 </span>
...
<div id="tab2" class="tab_content pd0">
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <span class="oneTwo"><textarea name="meta_key" id="param_meta_key" _autocheck="true" rows="4" cols=""><?php echo $row->meta_key ?></textarea></span>
