...
<div class="wrapper">
	   	...
	   	<!-- Form -->
<form class="form" id="form" action="<?php echo admin_url('product/add') ?>"a method="post" enctype= 					 																							"multipart/form-data">
	<fieldset>
    ...
    <div class="tab_container">
            ...
            <label class="formLeft" for="param_cat">Danh mục SP:<span class="req">*</span></label>
                <div class="formRight">
                  <select name="catalog_id" _autocheck="true" id="param_cat" class="left">
					...
					<?php  foreach($catalogs_data as $row):?>
       ...
       <div class="formRow">
        ...
        <div class="formRow">
			<label class="formLeft" for="param_name">Tên SP:<span class="req">*</span></label>
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <span class="oneTwo">
                    <input name="price" type="number" style="width:100px" id="param_price" class="format_number" _autocheck="true" 		 																										type="text">
