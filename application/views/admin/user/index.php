	...
	<div class="widget">
		...
		<div class="title">
			...
			<h6>Danh sách Thành viên </h6>
		 	<div class="num f12">Tổng số: <b><?php echo count($user_data)?></b></div>
		</div>
		...
		<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
 			...
 			<tfoot>
				<tr>
					<td colspan="7">
						...
						<a href="<?php echo admin_url('user/del_select')?>" id="submit" class="button blueB">
			...
			<tr>
                        ...
                        <td class="textC"><span class="tipS"><?php echo $row->address ?></span></td>
