	...
	<div class="widget">
		...
		<div class="title">
			...
			<h6>Danh sách danh mục sản phẩm</h6>
		 	<div class="num f12">Tổng số: <b><?php echo count($catalog_data)?></b></div>
		</div>
		...
		<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
 			...
 			<tfoot>
				<tr>
					<td colspan="7">
						...
						<a href="<?php echo admin_url('catalog/del_select')?>" id="submit" class="button blueB">
			...
			<tbody>
			<?php foreach ($catalog_data as $row):?>
			<tr>
						...
						<td>
						<span title="<?php echo $row->cata_name?>" class="tipS">
							<?php echo $row->cata_name?>				
						</span>
						</td>
