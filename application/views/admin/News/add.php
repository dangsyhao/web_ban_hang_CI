...
<div class="wrapper">
	   	...
	   	<!-- Form -->
<form class="form" id="form" action="<?php echo admin_url('news/add') ?>"a method="post" enctype= 					 																							"multipart/form-data">
	<fieldset>
    ...
    <div class="tab_container">
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <span class="oneTwo">
                   <input name="intro" style="width:100px" id="param_info"  _autocheck="true" type="text">
                 </span>
